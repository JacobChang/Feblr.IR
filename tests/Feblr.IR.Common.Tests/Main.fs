module Feblr.IR.Common.Tests

open Expecto
open Feblr.IR.Common
...
let tests =
    ...
    testList "BloomFilter"
        [ testCase "should return false for inexist item"
          <| fun _ -> Expect.equal (bloomFilter.has "hello") false "should return false"
